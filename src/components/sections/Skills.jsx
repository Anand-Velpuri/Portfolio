...
const ArgoCDIcon = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" {...props}>
    <defs>
      <clipPath id="argocd-e"><path d="M42 41h44v51H42zm0 0"/></clipPath>
      <clipPath id="argocd-d"><path d="M0 0h128v128H0z"/></clipPath>
      <clipPath id="argocd-c"><path d="M0 0h128v128H0z"/></clipPath>
      <clipPath id="argocd-f"><path d="M85.695 41.133l-2.55 58.238H44.887l-2.125-58.238"/></clipPath>
      <clipPath id="argocd-b"><path d="M0 0h128v128H0z"/></clipPath>
    </defs>
    ...
    <g clipPath="url(#argocd-e)"><g clipPath="url(#argocd-f)"><path d="M102.273 53.46c0 20.895-16.937 37.833-37.832 37.833-20.894 0-37.832-16.938-37.832-37.832 0-20.895 16.938-37.832 37.832-37.832 20.895 0 37.832 16.937 37.832 37.832zm0 0" fill="#ee794b"/></g></g>
...
export default function Skills() {
  const skillCategories = [
    ...
    {
      title: "Backend & Infra",
      skills: ["FastAPI", "Flask", "PostgreSQL", "MongoDB", "MySQL", "SQLAlchemy", "JWT / AES", "AWS", "Modal.com", "Docker", "Kubernetes", "Prometheus", "Grafana", "Vercel", "HF Spaces", "Git", "GitHub", "DVC", "DagsHub", "Apache Airflow", "Jenkins", "ArgoCD"]
    },
    {
      title: "AI Systems",
